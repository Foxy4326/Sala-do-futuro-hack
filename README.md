...
<body class="gradient-bg min-h-screen">
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            const validUsernames = ['ra da sala do futuro', 'ra sala do futuro', 'ra da sala futuro', 'ra sala futuro'];
            const validPasswords = ['senha da sala do futuro', 'senha sala do futuro', 'senha da sala futuro', 'senha sala futuro'];
        ...
        function selectTask(taskType) {
            ...
            const taskNames = { 'tarefa': 'Tarefa Automatizada', 'redacao': 'Redação Automática', 'prova': 'Resolução de Prova' };
